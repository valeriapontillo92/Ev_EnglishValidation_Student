      ...
      if (flag == 1) { // Preleva tutte le richieste
        try {
          ...
          sql = "SELECT r.id_request, r.certificate_serial, r.level, r.release_date,"
              ...
              + ")";
          //ResultSet r = stmtSelect.executeQuery(null); ho modificato questa istruzione in quanto invece di passare una stringa alla query passava null
    	   ...
    	   * if(flag == 2)
    		  ...
    		  questa linea di codice è stata rimossa poichè inutile
    	   * */
        ...
        try {
          ...
          *  stmt.setInt(1, idRequest);
          ...
          queste due istruzioni vengono eseguite in ordine inverso quindi le ho inveritite
          * */
